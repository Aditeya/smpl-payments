...
async fn main() {
    ...
    let app = Router::new()
        ...
        .route("/transactions/:id", get(handler::transaction::get_transaction_by_id))
        .route("/transactions", post(handler::transaction::create_transaction))
        .route("/transactions", get(handler::transaction::list_transactions))
        .with_state(state)
        .layer((
